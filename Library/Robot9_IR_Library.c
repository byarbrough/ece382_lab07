...
/**
 * converts the analong input from the right sensors -1.4
...
/**
 * converts the analong input from the left sensors - 1.5
 * Returns: digital value from ADC
 */
...
/**
 * converts the analong input from the front sensors - 1.3
 * Returns: digital value from ADC
 */
